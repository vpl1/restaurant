...
class Coupon extends AppModel {
     public $validate = array(
        ...
        'discount_fixed_price' => array(
            'valid' => array(
                'rule' => 'notBlank',
                'message' => 'Please enter a valid discount_fixed_price',
                'allowEmpty' => false
            )
        ),
        'discount_rate' => array(
            'valid' => array(
                'rule' => 'notBlank',
                'message' => 'Please enter a valid discount_rate',
                'allowEmpty' => false
            )
        ),
        'category_id' => array(
            'valid' => array(
                ...
                'message' => 'Please enter a valid category_id',
                'allowEmpty' => false
            )
        ),
        'description' => array(
        ...
        'end_date' => array(
            'valid' => array(
                'rule' =>'date' ,
                'message' => 'Please enter a end_date',
                'allowEmpty' => false
            )
        )
    );
    ...
    public function GetData() {
        $aColumns = array('id', 'code', 'type', 'name');
